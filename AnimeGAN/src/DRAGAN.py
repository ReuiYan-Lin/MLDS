...
class DRAGAN(object):
    ...
    def build_model(self):
        ...
        self.img_p = tf.placeholder(tf.float32, [self.batch_size, self.img_row, self.img_col, 3], name="img_p")
    ...
    def train(self):
        ...
        for t in range(self.iter):
            ...
            for d_ep in range(self.d_epoch):
                ...
                img_p = self.get_perturbed_batch(img)
